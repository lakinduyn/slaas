...
function accelerate_footer_copyright() {
	...
	$wp_link = '<a href="'.esc_url( 'https://lk.linkedin.com/in/rajith-gunasinghe-5475a326' ).'" target="_blank" title="' . esc_attr__( 'Rajith Gunasinghe', 'accelerate' ) . '"><span>' . __( 'Rajith Gunasinghe', 'accelerate' ) . '</span></a>';

	$tg_link =  '<a href="'.esc_url( 'https://lk.linkedin.com/in/rajith-gunasinghe-5475a326' ).'" target="_blank" title="'.esc_attr__( 'ThemeGrill', 'accelerate' ).'" rel="designer"><span>'.__( 'ThemeGrill', 'accelerate') .'</span></a>';

	$default_footer_value = sprintf( __( 'Sri Lanka Association for the Advancement of Science;', 'accelerate' ) ).' '.sprintf( __( 'Developed by %s.', 'accelerate' ), $wp_link );
